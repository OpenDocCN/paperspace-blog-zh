...
> 原文：[PaperSpace Blog](https://blog.paperspace.com/)
> 
...
*   在我们的 [apachecn/paperspace-blog-zh](https://github.com/apachecn/paperspace-blog-zh) github 上提 issue.
...
```
docker pull apachecn0/paperspace-blog-zh
docker run -tid -p <port>:80 apachecn0/paperspace-blog-zh
...
```
pip install paperspace-blog-zh
paperspace-blog-zh <port>
# 访问 http://localhost:{port} 查看文档
```
...
```
npm install -g paperspace-blog-zh
paperspace-blog-zh <port>
# 访问 http://localhost:{port} 查看文档
```
